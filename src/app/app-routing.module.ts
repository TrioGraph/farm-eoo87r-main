...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      // {
      //   path: 'identificationlist/:startDate',
      ...
      // { path: 'farmerlist/:startDate', component: FarmerListComponent, pathMatch: 'full' },
      // {
      //   path: 'farmerDetails',
      ...
      {path: 'authorisation-list/:startDate', component: AuthorisationListComponent, pathMatch:'full'},
...
{path: 'broadcast_message-list/:startDate', component: Broadcast_MessageListComponent, pathMatch:'full'},
...
{path: 'campaign_types-list/:startDate', component: Campaign_TypesListComponent, pathMatch:'full'},
...
{path: 'campaigns-list/:startDate', component: CampaignsListComponent, pathMatch:'full'},
...
{path: 'crop_variety-list/:startDate', component: Crop_VarietyListComponent, pathMatch:'full'},
...
{path: 'districts-list/:startDate', component: DistrictsListComponent, pathMatch:'full'},
...
{path: 'document_type-list/:startDate', component: Document_TypeListComponent, pathMatch:'full'},
...
{path: 'documents-list/:startDate', component: DocumentsListComponent, pathMatch:'full'},
...
{path: 'employee_roles-list/:startDate', component: Employee_RolesListComponent, pathMatch:'full'},
...
{path: 'employee_types-list/:startDate', component: Employee_TypesListComponent, pathMatch:'full'},
...
{path: 'employees-list/:startDate', component: EmployeesListComponent, pathMatch:'full'},
...
{path: 'farm_diseases-list/:startDate', component: Farm_DiseasesListComponent, pathMatch:'full'},
...
{path: 'farmer_group-list/:startDate', component: Farmer_GroupListComponent, pathMatch:'full'},
...
{path: 'farmer_login_visit_logs-list/:startDate', component: Farmer_login_visit_logsListComponent, pathMatch:'full'},
...
{path: 'farmer_trip_sheets-list/:startDate', component: Farmer_trip_sheetsListComponent, pathMatch:'full'},
...
{path: 'farmers-list/:startDate', component: FarmersListComponent, pathMatch:'full'},
...
{path: 'farmers_login-list/:startDate', component: Farmers_LoginListComponent, pathMatch:'full'},
...
{path: 'farmfield-list/:startDate', component: FarmFieldListComponent, pathMatch:'full'},
...
{path: 'field_visit-list/:startDate', component: Field_VisitListComponent, pathMatch:'full'},
{path: 'field_visit-details/:id', component: Field_VisitDetailsComponent, pathMatch:'full'},
{path: 'quick-field_visit', component: QuickFieldVisitComponent, pathMatch:'full'},
{path: 'add-field_visit', component: AddField_VisitComponent, pathMatch:'full'},
{path: 'logins-list/:startDate', component: LoginsListComponent, pathMatch:'full'},
...
{path: 'logins_log-list/:startDate', component: Logins_LogListComponent, pathMatch:'full'},
...
{path: 'mandal_blocks-list/:startDate', component: Mandal_BlocksListComponent, pathMatch:'full'},
...
{path: 'nursary-list/:startDate', component: NursaryListComponent, pathMatch:'full'},
...
{path: 'nursary_batches-list/:startDate', component: Nursary_BatchesListComponent, pathMatch:'full'},
...
{path: 'photos-list/:startDate', component: PhotosListComponent, pathMatch:'full'},
...
{path: 'plantationidentification-list/:startDate', component: PlantationIdentificationListComponent, pathMatch:'full'},
...
{path: 'poaching_ffb-list/:startDate', component: Poaching_FFBListComponent, pathMatch:'full'},
...
{path: 'privileges-list/:startDate', component: PrivilegesListComponent, pathMatch:'full'},
...
{path: 'referral_source-list/:startDate', component: Referral_SourceListComponent, pathMatch:'full'},
...
{path: 'role_privileges-list/:startDate', component: Role_PrivilegesListComponent, pathMatch:'full'},
...
{path: 'roles-list/:startDate', component: RolesListComponent, pathMatch:'full'},
...
{path: 'states-list/:startDate', component: StatesListComponent, pathMatch:'full'},
...
{path: 'training_videos-list/:startDate', component: Training_VideosListComponent, pathMatch:'full'},
...
{path: 'villages-list/:startDate', component: VillagesListComponent, pathMatch:'full'},
...
{path: 'workflow-list/:startDate', component: WorkflowListComponent, pathMatch:'full'},
