...
IsActive_data : any;
  ...
  this.ionicForm = this.formBuilder.group({
        photo_Type: ['', [Validators.required]],
photo_Blob: ['', [Validators.required]],
isActive: ['', [Validators.required]],
   ...
   this.dataService.getPhotosById(this.id).subscribe((data: any)=> {
      this.photosDetails = data;
  ...
  submitForm(): void {
   ...
   this.isLoading = true;
    this.dataService.updatePhotos(this.id, tempFormData).subscribe(async(data: any) => {
...
fileChange(event: any, propertyName: any) {
  ...
  uploadImage(propertyName: any) {
    ...
    formData.append('tableName', 'Photos');
