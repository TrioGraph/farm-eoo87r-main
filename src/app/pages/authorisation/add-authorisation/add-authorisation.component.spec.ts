...
import { CAuthorisationComponent } from './c-authorisation.component';

describe('CAuthorisationComponent', () => {
  let component: CAuthorisationComponent;
  let fixture: ComponentFixture<CAuthorisationComponent>;

  beforeEach(() => {
    const untypedFormBuilderStub = () => ({ group: object => ({}) });
    const nzDrawerRefStub = () => ({ close: data => ({}) });
    const nzNotificationServiceStub = () => ({
      create: (string, string1, fetchAuthorisationErrorMessage) => ({})
    });
    const FarmServiceStub = () => ({
      getAuthorisationById: value => ({ subscribe: f => f({}) }),
      updateAuthorisation: (value, value1) => ({ subscribe: f => f({}) }),
      addAuthorisation: value => ({ subscribe: f => f({}) }),
      resetForm: (e, appsForm) => ({})
    });
    TestBed.configureTestingModule({
      schemas: [NO_ERRORS_SCHEMA],
      declarations: [CAuthorisationComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(CAuthorisationComponent);
  ...
  describe('setFormData', () => {
    it('makes expected calls', () => {
      ...
      spyOn(appsServiceStub, 'getAuthorisationById').and.callThrough();
      component.setFormData();
      expect(nzNotificationServiceStub.create).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.getAuthorisationById).toHaveBeenCalled();
    });
  });
  ...
  describe('submitForm', () => {
    it('makes expected calls', () => {
      ...
      spyOn(nzNotificationServiceStub, 'create').and.callThrough();
      spyOn(appsServiceStub, 'updateAuthorisation').and.callThrough();
      spyOn(appsServiceStub, 'addAuthorisation').and.callThrough();
      component.submitForm();
      expect(nzDrawerRefStub.close).toHaveBeenCalled();
      expect(nzNotificationServiceStub.create).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.updateAuthorisation).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.addAuthorisation).toHaveBeenCalled();
    });
  });
});
