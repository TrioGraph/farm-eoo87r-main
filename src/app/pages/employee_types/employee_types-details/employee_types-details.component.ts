...
@Component({
  selector: 'app-employee_types-details',
  templateUrl: './employee_types-details.component.html',
  styleUrls: ['./employee_types-details.component.css']
})
export class Employee_TypesDetailsComponent implements OnInit {
...
isActive: ['', [Validators.required]],
   ...
   this.dataService.getEmployee_TypesById(this.id).subscribe((data: any)=> {
      this.employee_typesDetails = data;
  ...
  submitForm(): void {
   ...
   this.isLoading = true;
    this.dataService.updateEmployee_Types(this.id, tempFormData).subscribe(async(data: any) => {
