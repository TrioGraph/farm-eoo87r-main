...
import { CEmployee_TypesComponent } from './c-employee_types.component';

describe('CEmployee_TypesComponent', () => {
  let component: CEmployee_TypesComponent;
  let fixture: ComponentFixture<CEmployee_TypesComponent>;

  beforeEach(() => {
    const untypedFormBuilderStub = () => ({ group: object => ({}) });
    const nzDrawerRefStub = () => ({ close: data => ({}) });
    const nzNotificationServiceStub = () => ({
      create: (string, string1, fetchEmployee_TypesErrorMessage) => ({})
    });
    const FarmServiceStub = () => ({
      getEmployee_TypesById: value => ({ subscribe: f => f({}) }),
      updateEmployee_Types: (value, value1) => ({ subscribe: f => f({}) }),
      addEmployee_Types: value => ({ subscribe: f => f({}) }),
      resetForm: (e, appsForm) => ({})
    });
    TestBed.configureTestingModule({
      schemas: [NO_ERRORS_SCHEMA],
      declarations: [CEmployee_TypesComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(CEmployee_TypesComponent);
  ...
  describe('setFormData', () => {
    it('makes expected calls', () => {
      ...
      spyOn(appsServiceStub, 'getEmployee_TypesById').and.callThrough();
      component.setFormData();
      expect(nzNotificationServiceStub.create).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.getEmployee_TypesById).toHaveBeenCalled();
    });
  });
  ...
  describe('submitForm', () => {
    it('makes expected calls', () => {
      ...
      spyOn(nzNotificationServiceStub, 'create').and.callThrough();
      spyOn(appsServiceStub, 'updateEmployee_Types').and.callThrough();
      spyOn(appsServiceStub, 'addEmployee_Types').and.callThrough();
      component.submitForm();
      expect(nzDrawerRefStub.close).toHaveBeenCalled();
      expect(nzNotificationServiceStub.create).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.updateEmployee_Types).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.addEmployee_Types).toHaveBeenCalled();
    });
  });
});
