...
@Component({
  selector: 'app-quick-field-visit',
  templateUrl: './quick-field-visit.component.html',
  styleUrls: ['./quick-field-visit.component.scss'],
})
export class QuickFieldVisitComponent  implements OnInit {
  ...
  ngOnInit(): void {
    this.ionicForm = this.formBuilder.group({
      ...
      visist_Schedule_Date: [{value: '', disabled: true}, [Validators.required]],
