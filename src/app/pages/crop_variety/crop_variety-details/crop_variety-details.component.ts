...
@Component({
  selector: 'app-crop_variety-details',
  templateUrl: './crop_variety-details.component.html',
  styleUrls: ['./crop_variety-details.component.css']
})
export class Crop_VarietyDetailsComponent implements OnInit {
...
isActive: ['', [Validators.required]],
   ...
   this.dataService.getCrop_VarietyById(this.id).subscribe((data: any)=> {
      this.crop_varietyDetails = data;
  ...
  submitForm(): void {
   ...
   this.isLoading = true;
    this.dataService.updateCrop_Variety(this.id, tempFormData).subscribe(async(data: any) => {
