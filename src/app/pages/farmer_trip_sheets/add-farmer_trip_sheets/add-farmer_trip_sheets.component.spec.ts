...
import { CFarmer_trip_sheetsComponent } from './c-farmer_trip_sheets.component';

describe('CFarmer_trip_sheetsComponent', () => {
  let component: CFarmer_trip_sheetsComponent;
  let fixture: ComponentFixture<CFarmer_trip_sheetsComponent>;

  beforeEach(() => {
    const untypedFormBuilderStub = () => ({ group: object => ({}) });
    const nzDrawerRefStub = () => ({ close: data => ({}) });
    const nzNotificationServiceStub = () => ({
      create: (string, string1, fetchFarmer_trip_sheetsErrorMessage) => ({})
    });
    const FarmServiceStub = () => ({
      getFarmer_trip_sheetsById: value => ({ subscribe: f => f({}) }),
      updateFarmer_trip_sheets: (value, value1) => ({ subscribe: f => f({}) }),
      addFarmer_trip_sheets: value => ({ subscribe: f => f({}) }),
      resetForm: (e, appsForm) => ({})
    });
    TestBed.configureTestingModule({
      schemas: [NO_ERRORS_SCHEMA],
      declarations: [CFarmer_trip_sheetsComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(CFarmer_trip_sheetsComponent);
  ...
  describe('setFormData', () => {
    it('makes expected calls', () => {
      ...
      spyOn(appsServiceStub, 'getFarmer_trip_sheetsById').and.callThrough();
      component.setFormData();
      expect(nzNotificationServiceStub.create).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.getFarmer_trip_sheetsById).toHaveBeenCalled();
    });
  });
  ...
  describe('submitForm', () => {
    it('makes expected calls', () => {
      ...
      spyOn(nzNotificationServiceStub, 'create').and.callThrough();
      spyOn(appsServiceStub, 'updateFarmer_trip_sheets').and.callThrough();
      spyOn(appsServiceStub, 'addFarmer_trip_sheets').and.callThrough();
      component.submitForm();
      expect(nzDrawerRefStub.close).toHaveBeenCalled();
      expect(nzNotificationServiceStub.create).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.updateFarmer_trip_sheets).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.addFarmer_trip_sheets).toHaveBeenCalled();
    });
  });
});
