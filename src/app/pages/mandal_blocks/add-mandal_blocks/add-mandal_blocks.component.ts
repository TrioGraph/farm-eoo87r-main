...
@Component({
  selector: 'app-add-mandal_blocks',
  templateUrl: './add-mandal_blocks.component.html',
  styleUrls: ['./add-mandal_blocks.component.css']
})
export class AddMandal_BlocksComponent implements OnInit {
...
isActive: ['', [Validators.required]],
  ...
  cancelForm() {
    this.router.navigateByUrl('farm/mandal_blocks-list')
  }
...
async addNewRecord() {
    ...
    tempFormData.tableName = 'Mandal_Blocks';
    // tempFormData.id = '1234567';
      ...
      async (data: any) => {
        this.id = data;
        this.title = 'Mandal_Blocks: ' + this.id;
