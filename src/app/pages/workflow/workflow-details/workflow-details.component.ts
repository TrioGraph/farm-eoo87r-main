...
isActive: ['', [Validators.required]],
   ...
   this.dataService.getWorkflowById(this.id).subscribe((data: any)=> {
  ...
  submitForm(): void {
   ...
   this.isLoading = true;
    this.dataService.updateWorkflow(this.id, tempFormData).subscribe(async(data: any) => {
...
fileChange(event: any, propertyName: any) {
  ...
  uploadImage(propertyName: any) {
    ...
    formData.append('tableName', 'Workflow');
