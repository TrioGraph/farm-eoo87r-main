...
isActive: ['', [Validators.required]],
   ...
   this.id = this.route.snapshot.paramMap.get('id')!;
     ...
     this.dataService.getStatesLookup().subscribe((result: any) => { 
	 this.State_Id_data = result; 
}); 
  ...
  cancelForm() {
    this.router.navigateByUrl('farm/districts-list')
  }
...
async addNewRecord() {
    ...
    tempFormData.tableName = 'Districts';
...
fileChange(event: any, propertyName: any) {
  ...
  uploadImage(propertyName: any) {
    ...
    formData.append('tableName', 'Districts');
