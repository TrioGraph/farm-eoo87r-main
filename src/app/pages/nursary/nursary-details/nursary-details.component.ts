...
@Component({
  selector: 'app-nursary-details',
  templateUrl: './nursary-details.component.html',
  styleUrls: ['./nursary-details.component.css']
})
export class NursaryDetailsComponent implements OnInit {
...
isActive: ['', [Validators.required]],
   ...
   this.dataService.getNursaryById(this.id).subscribe((data: any)=> {
      this.nursaryDetails = data;
  ...
  submitForm(): void {
   ...
   this.isLoading = true;
    this.dataService.updateNursary(this.id, tempFormData).subscribe(async(data: any) => {
