...
isActive: ['', [Validators.required]],
   ...
   this.dataService.getRolesById(this.id).subscribe((data: any)=> {
  ...
  submitForm(): void {
   ...
   this.isLoading = true;
    this.dataService.updateRoles(this.id, tempFormData).subscribe(async(data: any) => {
...
fileChange(event: any, propertyName: any) {
  ...
  uploadImage(propertyName: any) {
    ...
    formData.append('tableName', 'Roles');
