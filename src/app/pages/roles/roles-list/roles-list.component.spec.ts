...
import { VRolesComponent } from './v-Roles.component';

describe('VRolesComponent', () => {
  let component: VRolesComponent;
  let fixture: ComponentFixture<VRolesComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: FarmService, useFactory: rolesServiceStub }
      ]
    });
    fixture = TestBed.createComponent(VRolesComponent);
  ...
  describe('fetchPermissions', () => {
    it('makes expected calls', () => {
      const rolesServiceStub: RolesService = fixture.debugElement.injector.get(
        FarmService
      );
      spyOn(rolesServiceStub, 'validatePermissionWithRole').and.callThrough();
      component.fetchPermissions();
      expect(rolesServiceStub.validatePermissionWithRole).toHaveBeenCalled();
    });
  });
  ...
  describe('fetchData', () => {
    it('makes expected calls', () => {
      ...
      spyOn(rolesServiceStub, 'getRoles').and.callThrough();
      component.fetchData();
      expect(nzNotificationServiceStub.create).toHaveBeenCalled();
      expect(rolesServiceStub.getRoles).toHaveBeenCalled();
    });
  });
});
