...
@Component({
  selector: 'app-nursary_activity-details',
  templateUrl: './nursary_activity-details.component.html',
  styleUrls: ['./nursary_activity-details.component.css']
})
export class Nursary_ActivityDetailsComponent implements OnInit {
...
isActive: ['', [Validators.required]],
   ...
   this.dataService.getNursary_ActivityById(this.id).subscribe((data: any)=> {
      this.nursary_activityDetails = data;
  ...
  submitForm(): void {
   ...
   this.isLoading = true;
    this.dataService.updateNursary_Activity(this.id, tempFormData).subscribe(async(data: any) => {
