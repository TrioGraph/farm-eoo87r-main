...
import { VFarmersComponent } from './v-Farmers.component';

describe('VFarmersComponent', () => {
  let component: VFarmersComponent;
  let fixture: ComponentFixture<VFarmersComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: FarmService, useFactory: farmersServiceStub }
      ]
    });
    fixture = TestBed.createComponent(VFarmersComponent);
  ...
  describe('fetchPermissions', () => {
    it('makes expected calls', () => {
      const farmersServiceStub: FarmersService = fixture.debugElement.injector.get(
        FarmService
      );
      spyOn(farmersServiceStub, 'validatePermissionWithRole').and.callThrough();
      component.fetchPermissions();
      expect(farmersServiceStub.validatePermissionWithRole).toHaveBeenCalled();
    });
  });
  ...
  describe('fetchData', () => {
    it('makes expected calls', () => {
      ...
      spyOn(farmersServiceStub, 'getFarmers').and.callThrough();
      component.fetchData();
      expect(nzNotificationServiceStub.create).toHaveBeenCalled();
      expect(farmersServiceStub.getFarmers).toHaveBeenCalled();
    });
  });
});
