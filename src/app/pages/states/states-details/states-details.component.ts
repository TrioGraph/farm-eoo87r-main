...
isActive: ['', [Validators.required]],
   ...
   this.dataService.getStatesById(this.id).subscribe((data: any)=> {
  ...
  submitForm(): void {
   ...
   this.isLoading = true;
    this.dataService.updateStates(this.id, tempFormData).subscribe(async(data: any) => {
...
fileChange(event: any, propertyName: any) {
  ...
  uploadImage(propertyName: any) {
    ...
    formData.append('tableName', 'States');
