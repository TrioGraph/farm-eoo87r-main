...
import { VStatesComponent } from './v-States.component';

describe('VStatesComponent', () => {
  let component: VStatesComponent;
  let fixture: ComponentFixture<VStatesComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: FarmService, useFactory: statesServiceStub }
      ]
    });
    fixture = TestBed.createComponent(VStatesComponent);
  ...
  describe('fetchPermissions', () => {
    it('makes expected calls', () => {
      const statesServiceStub: StatesService = fixture.debugElement.injector.get(
        FarmService
      );
      spyOn(statesServiceStub, 'validatePermissionWithRole').and.callThrough();
      component.fetchPermissions();
      expect(statesServiceStub.validatePermissionWithRole).toHaveBeenCalled();
    });
  });
  ...
  describe('fetchData', () => {
    it('makes expected calls', () => {
      ...
      spyOn(statesServiceStub, 'getStates').and.callThrough();
      component.fetchData();
      expect(nzNotificationServiceStub.create).toHaveBeenCalled();
      expect(statesServiceStub.getStates).toHaveBeenCalled();
    });
  });
});
