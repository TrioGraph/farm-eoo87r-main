...
import { CFarm_DiseasesComponent } from './c-farm_diseases.component';

describe('CFarm_DiseasesComponent', () => {
  let component: CFarm_DiseasesComponent;
  let fixture: ComponentFixture<CFarm_DiseasesComponent>;

  beforeEach(() => {
    const untypedFormBuilderStub = () => ({ group: object => ({}) });
    const nzDrawerRefStub = () => ({ close: data => ({}) });
    const nzNotificationServiceStub = () => ({
      create: (string, string1, fetchFarm_DiseasesErrorMessage) => ({})
    });
    const FarmServiceStub = () => ({
      getFarm_DiseasesById: value => ({ subscribe: f => f({}) }),
      updateFarm_Diseases: (value, value1) => ({ subscribe: f => f({}) }),
      addFarm_Diseases: value => ({ subscribe: f => f({}) }),
      resetForm: (e, appsForm) => ({})
    });
    TestBed.configureTestingModule({
      schemas: [NO_ERRORS_SCHEMA],
      declarations: [CFarm_DiseasesComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(CFarm_DiseasesComponent);
  ...
  describe('setFormData', () => {
    it('makes expected calls', () => {
      ...
      spyOn(appsServiceStub, 'getFarm_DiseasesById').and.callThrough();
      component.setFormData();
      expect(nzNotificationServiceStub.create).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.getFarm_DiseasesById).toHaveBeenCalled();
    });
  });
  ...
  describe('submitForm', () => {
    it('makes expected calls', () => {
      ...
      spyOn(nzNotificationServiceStub, 'create').and.callThrough();
      spyOn(appsServiceStub, 'updateFarm_Diseases').and.callThrough();
      spyOn(appsServiceStub, 'addFarm_Diseases').and.callThrough();
      component.submitForm();
      expect(nzDrawerRefStub.close).toHaveBeenCalled();
      expect(nzNotificationServiceStub.create).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.updateFarm_Diseases).toHaveBeenCalled();
      expect(<<ProjecteInstanceName>>ServiceStub.addFarm_Diseases).toHaveBeenCalled();
    });
  });
});
