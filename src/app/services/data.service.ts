...
searchGender(searchText: any, pageNumber: any, pageSize: any, sortColumn: any, sortOrder: any): Observable<any> {
  return this.http.get<any>(`${this.apiURL}SearchGender?searchText=` + searchText + `&pageNumber=` + pageNumber + `&pageSize=` + pageSize + `&sortColumn=` + sortColumn + `&sortOrder=` + sortOrder )
}
...
searchPrivileges(searchText: any, pageNumber: any, pageSize: any, sortColumn: any, sortOrder: any): Observable<any> {
  return this.http.get<any>(`${this.apiURL}SearchPrivileges?searchText=` + searchText + `&pageNumber=` + pageNumber + `&pageSize=` + pageSize + `&sortColumn=` + sortColumn + `&sortOrder=` + sortOrder )
}
...
searchRole_Privileges(searchText: any, pageNumber: any, pageSize: any, sortColumn: any, sortOrder: any): Observable<any> {
  return this.http.get<any>(`${this.apiURL}SearchRole_Privileges?searchText=` + searchText + `&pageNumber=` + pageNumber + `&pageSize=` + pageSize + `&sortColumn=` + sortColumn + `&sortOrder=` + sortOrder )
}
...
getRolesLookup(): Observable<any> {
  return this.http.get<any>(`${this.apiURL}getRolesLookup`)
}
...
searchRoles(searchText: any, pageNumber: any, pageSize: any, sortColumn: any, sortOrder: any): Observable<any> {
  return this.http.get<any>(`${this.apiURL}SearchRoles?searchText=` + searchText + `&pageNumber=` + pageNumber + `&pageSize=` + pageSize + `&sortColumn=` + sortColumn + `&sortOrder=` + sortOrder )
}
